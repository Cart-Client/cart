...
public final class CrystalUtil {
    public static boolean method392(final BlockPos block) {
        final int n = 0;
        final BlockState getBlockState = Client.mc.world.getBlockState(block);
        final int n2 = n;
    ...
    public static boolean hasNoEntityOnIt(final BlockPos block) {
        ...
        final int n2 = n;
        int n4;
        final int n3 = n4 = (Client.mc.world.isAir(up) ? 1 : 0);
        if (n2 == 0) {
            if (n3 == 0) {
                return false;
            }
        ...
        return Client.mc.world.getOtherEntities(null, new Box(n5, n6, n7, n5 + 1.0, n6 + 2.0, n7 + 1.0)).isEmpty();
    }

    public static boolean method394(final BlockPos pos) {
        final int n = 0;
        final BlockState getBlockState = Client.mc.world.getBlockState(pos);
        final int n2 = n;
